    ...
    <div class="container-fluid py-5 mb-5" style="background: linear-gradient(rgba(40, 167, 69, 0.85), rgba(32, 201, 151, 0.85)), url('frontend/img/carousel-5.png') center/cover;">
        <div class="container py-5">
            <div class="row justify-content-center text-center">
                <div class="col-lg-10">
                    <h1 class="display-4 fw-bold text-white mb-3">Artikel & Tips Budidaya</h1>
                    <p class="lead text-white mb-4">Temukan panduan lengkap budidaya bibit kentang, tips perawatan, dan informasi terbaru seputar pertanian kentang dari FredianFarm</p>
                    <div class="d-flex flex-wrap justify-content-center gap-3">
                        <span class="badge bg-warning text-dark fs-6 py-2 px-3">
                            <i class="fas fa-seedling me-2"></i>Tips Praktis
                        </span>
                        <span class="badge bg-light text-success fs-6 py-2 px-3">
                            <i class="fas fa-clipboard-check me-2"></i>Panduan Lengkap
                        </span>
                        <span class="badge bg-warning text-dark fs-6 py-2 px-3">
                            <i class="fas fa-virus-slash me-2"></i>Pencegahan Penyakit
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="mb-5">
                    <form action="<?= route_to('search-posts') ?>" method="GET">
                        <div class="input-group">
                            <input type="text" name="q" class="form-control p-3" placeholder="Keywords" value="<?= old('q') ?>">
