...
<?= $this->section('content') ?>
    <!-- Hero Start -->
    <div class="container-fluid py-5 mb-5" style="background: linear-gradient(rgba(40, 167, 69, 0.85), rgba(32, 201, 151, 0.85)), url('frontend/img/carousel-5.png') center/cover;" hidden>
        <div class="container py-5">
            <div class="row justify-content-center text-center">
                <div class="col-lg-10">
                    <h1 class="display-4 fw-bold text-white mb-3">Artikel Berdasarkan Kategori</h1>
                    <p class="lead text-white mb-4">Temukan artikel budidaya kentang yang sesuai dengan kebutuhan dan minat Anda</p>
                    <div class="d-flex flex-wrap justify-content-center gap-3">
                        <span class="badge bg-warning text-dark fs-6 py-2 px-3">
                            <i class="fas fa-tags me-2"></i>Kategori Artikel
                        </span>
                        <span class="badge bg-light text-success fs-6 py-2 px-3">
                            <i class="fas fa-filter me-2"></i>Filter Konten
                        </span>
                        <span class="badge bg-warning text-dark fs-6 py-2 px-3">
                            <i class="fas fa-search me-2"></i>Pencarian Spesifik
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-8">
                ...
                <div class="mx-auto text-center mb-5">
                    <h6 class="text-primary text-uppercase">Category Posts</h6>
                    <h1 class="display-5 mb-0">Category: <?= $category_name ?? $category->name ?></h1>
                    ...
                    <?php else : ?>
                        <div class="col-12">
                            <div class="alert alert-info text-center py-5">
                                <i class="bi bi-folder display-4 d-block text-muted mb-3"></i>
                                <h4 class="text-muted">No posts found</h4>
                                <p class="text-muted">No posts found in category "<?= $category_name ?? $category->name ?>"</p>
